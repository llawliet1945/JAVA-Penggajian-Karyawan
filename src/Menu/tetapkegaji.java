...
public class tetapkegaji extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblGaji.setBackground(new java.awt.Color(240, 240, 240));
    ...
    private void tblGajiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblGajiMouseClicked
        int brs = tblGaji.getSelectedRow();
        st.nip = UserTab.getValueAt(brs, 0).toString();
        st.nama = UserTab.getValueAt(brs, 1).toString();
        st.gaji = UserTab.getValueAt(brs, 4).toString();
        st.PegawaiTerpilih();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tetapkegaji.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tetapkegaji().setVisible(true);
            }
        });
    }
