...
public class SlipTetap extends javax.swing.JFrame {
    ...
    protected void autonumber(){
        try{
            String Query = "Select kode_slip from slip_tetap order by kode_slip asc";
            Statement st = conn.createStatement();
            ResultSet Res = st.executeQuery(Query);
            txtkd.setText("SGT0001");
            while(Res.next()){
    ...
    public void PegawaiTerpilih(){
        tetapkegaji tg = new tetapkegaji();
        tg.st = this;
        txtnip.setText(nip);
    ...
    public void UserModelTable(){
        ...
        try{
            String sql = "SELECT * FROM slip_tetap where kode_slip like'%"+cari+"%' order by kode_slip asc";
            Statement st = conn.createStatement();
    ...
    protected void hitung(){
        ...
        int total = gapok-(cuti*75000)+(lmbr*65000);
    ...
    private void initComponents() {
        ...
        TableUser.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Slip", "NIP Pegawai", "ID Admin", "Tanggal Slip", "Jumlah Cuti", "Jumlah Lembur", "Total"
            }
        ));
        ...
        jLabel7.setText("Slip Pegawai Tetap");
    ...
    private void btambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btambahActionPerformed
        ...
        String sql = "insert into slip_tetap values (?,?,?,?,?,?,?)";
        try{
        ...
        }UserModelTable(); autonumber(); clear();
    ...
    private void bdeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bdeleteActionPerformed
        ...
        if(ok==0){
            String sql = "DELETE FROM slip_tetap where kode_slip = '"+txtkd.getText()+"'";
            try{
                PreparedStatement st = conn.prepareStatement(sql);
                st.executeUpdate();
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        SimpleDateFormat Date = new SimpleDateFormat("yyyy/MM/dd");
        String FormDate = Date.format(jtgl.getDate());
        String sql = "update slip_tetap set nip=?, id_admin=?, tgl_slip=?, total_cuti=?, total_lembur=?, total=? where kode_slip='"+txtkd.getText()+"'";
        try{
            PreparedStatement st = conn.prepareStatement(sql);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try{
            String File1 = "src/Menu/sliptetap.jasper";
