...
public class PegawaiTetap extends javax.swing.JFrame {
    ...
    public void PegawaiModelTable(){
        ...
        try{
            String sql = "SELECT * FROM pegawai_tetap where nip like'%"+cari+"%' order by nip asc";
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Pegawai Tetap");

        jLabel8.setText("Jabatan");

        cbjabatan.setBackground(new java.awt.Color(240, 240, 240));
        cbjabatan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " ", "Akuntan", "Data Analyst", "UI Designeer", "Programmer", "Project Manager", "System Analyst" }));
    ...
    private void btambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btambahActionPerformed
        String sql = "insert into pegawai_tetap values (?,?,?,?,?)";
        try{
    ...
    private void bdeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bdeleteActionPerformed
        ...
        if(ok==0){
            String sql = "DELETE FROM pegawai_tetap where nip = '"+txtnip.getText()+"'";
            try{
                PreparedStatement st = conn.prepareStatement(sql);
                st.executeUpdate();
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
         String sql = "update pegawai_tetap set nama=?, alamat=?, jabatan=?, gaji=? where nip='"+txtnip.getText()+"'";
        try{
            PreparedStatement st = conn.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PegawaiTetap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
